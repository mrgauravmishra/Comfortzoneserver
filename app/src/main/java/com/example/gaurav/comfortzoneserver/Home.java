...
import com.example.gaurav.comfortzoneserver.Model.Category;
import com.example.gaurav.comfortzoneserver.ViewHolder.MenuViewHolder;
            ...
            protected void onBindViewHolder(@NonNull MenuViewHolder viewHolder, int i, @NonNull Category model) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        //send cateory id and start new activity
